	...
	<body class="premium standard u-fix-fancybox-iframe">
		<form>
			...
			<div class="wrapper mod-standard mod-gray">
                ...
                <asp:Repeater runat="server" ID="artistHeaderInfo">
                    <ItemTemplate>
                        <div class="details-banner">
                            <div class="details-banner--overlay"></div>
                            <div class="details-banner--hero">
                                <img class="details-banner--hero--img" src="<%#Eval("artistHeroUrl") %>"
                                    srcset="<%#Eval("artistImageUrl") %>, <%#Eval("artistImageUrl") %> 2x" alt="<%#Eval("artistTitle") %>">
                            </div>
				...
				<div class="discovery--container u-container">
							<main class="discovery--section">
                                            ...
                                            <ItemTemplate>
                                                <li class="song-list--item media-player--row">
                                                    ...
                                                    <div class="song-list--item--right">
                                                        ...
                                                        <a class="song-list--item--secondary"><%#Eval("songBPM") %> BPM</a>
                                ...
                                <section class="standard--holder">
                                    ...
                                    <asp:Repeater runat="server" ID="artistBiography">
                                        <ItemTemplate>
                                            <div class="artist-details--biography biography">
                                                <p><%#Eval("artistBiography") %></p>
                                                <a href="#">Read More...</a>
                                            </div>
                                        </ItemTemplate>
                                    </asp:Repeater>
